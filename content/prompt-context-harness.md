...
Agent 最常犯的两类错：一是跨层依赖，二是明明已有类似实现，还要自己再造一个。这两类问题通过 ESLint 和 CR Skill 基本解决（详见[Agent 每犯一类错，就多一条 lint 规则](../lint-rules-for-agents/)）。**质量保障的本质，不是检查 AI 写的代码，而是让 AI 的错误类型越来越少。**
